              ...
              <DialogPanel class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-100 sm:max-w-lg">
                <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div class="sm:flex sm:items-start">
                    <div class="mx-auto d-flex h-12 w-12 flex-shrink-0 align-center justify-center rounded-full bg-green-400 sm:mx-0 sm:h-10 sm:w-10">
                    ...
                    <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div class="mt-2">
                        <input type="text" placeholder="Password" v-model="password" class="mt-1 block w-100 px-3 py-2 bg-white border-width border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
                ...
                <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                    <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-weight-medium rounded text-sm px-5 py-2 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" @click="check()">Send</button>
                </div>
              </DialogPanel>
            </TransitionChild>
          </div>
